...
JNI_ACTIVITY_FN(initV1)(JNIEnv *env, jobject, jlong fhAppHandle, jstring mainResourcePath,
                        jstring userResourcePath) {
    return fh_init_v1((FHAppHandle) fhAppHandle, jstringToChar(env, mainResourcePath),
                      jstringToChar(env, userResourcePath));
}
...
extern "C" JNIEXPORT jint JNICALL
JNI_ACTIVITY_FN(setMapRenderWindowV1)(JNIEnv *env, jobject, jlong fhAppHandle, jint x, jint y,
                                      jint z,
                                      jint width, jint height) {
    return fh_set_map_render_window_v1((FHAppHandle) fhAppHandle, (int) x, (int) y, (int) z,
