...
void DefParser::loadSoD(uint32_t type)
{
    ...
    uint32_t totalBlocks; ds >> totalBlocks;
    ...
    {
        int32_t blockID; ds >> blockID;
        int32_t totalEntries; ds >> totalEntries;
        ...
        {
            uint32_t currOffset; ds >> currOffset;
