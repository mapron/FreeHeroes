...
public:
    DarkFrameLabel(QWidget * parent = nullptr) : QLabel(parent) {
    ...
    DarkFrameLabel(const QString & txt, QWidget * parent = nullptr) : DarkFrameLabel(parent) { setText(txt); }
};
...
public:
    DarkFrameLabelIcon(QWidget * parent) : DarkFrameLabel(parent) { }
...
public:
    FlatLabelIcon(QWidget * parent = nullptr) : DarkFrameLabelIcon(parent) {
...
public:
    DarkFrame(QWidget * parent = nullptr) : QFrame(parent) {
        this->setFrameStyle(QFrame::Panel);
        this->setLineWidth(2);
        this->setProperty("borderStyle", "commonDark");
        this->setProperty("fill", true);
