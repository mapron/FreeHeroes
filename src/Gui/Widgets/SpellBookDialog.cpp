...
{
public:
    TransparentButton(QWidget * parent) : QPushButton(parent) {}
...
public:
    ...
    TransparentLabel(QWidget * parent) : QLabel(parent) {
...
public:
    ...
    SpellBg(QWidget * parent) : QFrame(parent) {
...
public:
    SpellCell(QWidget * parent) : QWidget(parent) {
...
struct SpellBookDialog::Impl {
    ...
    Impl(const SpellsModel * spellsModel) : spellsModel(spellsModel) {}
};
